...
const slides = [
  {
    ...
    subtitle:
      "Browse verified listings from nearby providers and reserve your ride with clear pricing and real-time status.",
  ...
  },
  {
    ...
    subtitle:
      "Add your car with photos, category, location and price per day. Track bookings and update availability anytime.",
  ...
  {
    title: "Safer rentals with clear availability",
    subtitle:
      "See Available/Booked badges, prevent double booking, and get support whenever you need it.",
